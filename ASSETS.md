...
Only assets that the game actually uses are committed (under `Assets/ThirdParty/<publisher>/<pack>`, each with its
`License.txt`). The complete packs are kept in `local_assets/` on the developer's machine (git-ignored) so more pieces can be
pulled in when needed. All packs below are CC0 (public domain); credit is optional.
...
| Kenney Holiday Kit | https://kenney.nl/assets/holiday-kit | `local_assets/kenney_holiday-kit` | none yet |
| Kenney Nature Kit | https://kenney.nl/assets/nature-kit | `local_assets/kenney_nature-kit` | none yet |
...
| KayKit Dungeon Pack 1.1 | https://kaylousberg.itch.io/kaykit-dungeon | `local_assets/KayKit_Dungeon_Pack_1.1_FREE` | none yet |
| KayKit Adventurers 2.0 | https://kaylousberg.itch.io/kaykit-adventurers | `local_assets/KayKit_Adventurers_2.0_FREE` | none yet |
| KayKit Skeletons 1.1 | https://kaylousberg.itch.io | `local_assets/KayKit_Skeletons_1.1_FREE` | none yet |
| Quaternius Ultimate Monsters | https://quaternius.com | `local_assets/Ultimate Monsters` | none yet |
